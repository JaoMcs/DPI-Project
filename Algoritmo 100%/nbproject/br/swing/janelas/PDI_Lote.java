...
public class PDI_Lote extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Contrast Enhancement Algorithms - 100%");
        ...
        tecnica01.setText("Equaliza��o Polinomial");
        ...
        try {
            ...
            if (!CaminhoImagemOriginal.getText().isEmpty() && !CaminhoSaidaImagem.getText().isEmpty()) {
                ...
                if (tecnica01.isSelected()) {
                    String k = JOptionPane.showInputDialog(null, "Entre com um valor para A (entre -1 e 0): ");
